...
<div class="enquire-9rH">
  <div class="group-271-Jz5">
    <div class="rectangle-174-rkh">
    </div>
  
    <div class="rectangle-173-3qB">
    </div>
    <div class="rectangle-175-aq7">
    </div>
    <div class="train-tracks-1-G5f">
      <div class="train-tracks-1-G5f-bg">
      </div>
    </div>
    <div class="testbox">
      <form action="enqurr.php" method="post">
        <div class="banner">
